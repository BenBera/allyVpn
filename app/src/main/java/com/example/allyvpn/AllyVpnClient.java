...
public class AllyVpnClient extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.connect).setOnClickListener(v -> {
            ...
            prefs.edit()
                    ...
                    .apply();
            Intent intent = VpnService.prepare(AllyVpnClient.this);
            if (intent != null) {
        ...
        findViewById(R.id.disconnect).setOnClickListener(v -> startService(getServiceIntent().setAction(AllyVpnService.ACTION_DISCONNECT)));
    }
    ...
    private boolean checkPackages(Set<String> packageNames) {
        @SuppressLint("QueryPermissionsNeeded") final boolean hasCorrectPackageNames = packageNames.isEmpty() ||
    ...
    protected void onActivityResult(int request, int result, Intent data) {
        if (result == RESULT_OK) {
            startService(getServiceIntent().setAction(AllyVpnService.ACTION_CONNECT));
        }
    }
    private Intent getServiceIntent() {
        return new Intent(this, AllyVpnService.class);
    }
}
