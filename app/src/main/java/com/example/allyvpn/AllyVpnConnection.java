...
public class AllyVpnConnection implements Runnable {
    /**
     * Callback interface to let the {@link AllyVpnService} know about new connections
    ...
    public AllyVpnConnection(final VpnService service, final int connectionId, final String serverName, final int serverPort, final byte[] sharedSecret,
    ...
    private final String getTag() {
        return AllyVpnConnection.class.getSimpleName() + "[" + mConnectionId + "]";
    }
